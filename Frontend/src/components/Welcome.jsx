...
const Welcome = () => {
  ...
  const sutitleRef = useRef(null);

  useGSAP(() => {
    const titleCleanUp = setupTextHover(titleRef.current, "title");
    const subtitleCleanUp = setupTextHover(sutitleRef.current, "subtitle");
  ...
  return (
    <section id="welcome">
      ...
      {/* #TODO:Design this for mobile view */}
